...
export const siteConfig: SiteConfig = {
	...
	bilibili: {
		vmid: "454341051", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/luofish/Mizuki",
					external: true,
					icon: "fa7-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/454341051",
					external: true,
					icon: "fa7-brands:bilibili",
				},
				{
					name: "Gitee",
					url: "https://gitee.com/luoxfish",
					external: true,
					icon: "mdi:git",
				},
			],
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://luofish.netlify.app/.netlify/functions/twikoo",
		lang: SITE_LANG,
	},
};
...
export const announcementConfig: AnnouncementConfig = {
	title: "最新公告", // 公告标题，填空使用i18n字符串Key.announcement
	content: "欢迎光临我的博客", // 公告内容
